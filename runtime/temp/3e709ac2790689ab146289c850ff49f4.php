<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:62:"D:\www\myBlog\public/../application/admin\view\link\index.html";i:1500951663;s:56:"D:\www\myBlog\public/../application/admin\view\base.html";i:1522220727;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<ul class="nav nav-tabs" role="tablist">
    ...
    <li><a href="<?php echo url('admin/Link/add'); ?>">添加友链</a></li>
</ul>
...
<script>
    function  del(link_id) {
        ...
        layer.confirm('确定要删除吗？', {
            ...
            window.location.href = "<?php echo url('del'); ?>"+"?link_id="+link_id;
        });
    }
</script>
