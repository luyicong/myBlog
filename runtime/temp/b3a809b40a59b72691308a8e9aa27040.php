<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\www\myBlog\public/../application/index\view\detail\index.html";i:1513586259;s:56:"D:\www\myBlog\public/../application/index\view\base.html";i:1501222420;}*/ ?>
<!DOCTYPE html>
<head>
...
<article>
    ...
    <div class="comments_wrap">
        <h3>评论列表：</h3>
        <?php if(is_array($comments) || $comments instanceof \think\Collection || $comments instanceof \think\Paginator): if( count($comments)==0 ) : echo "" ;else: foreach($comments as $key=>$vo): if($vo['pid'] == '0'): ?><hr class="solidline"/><?php else: ?><hr class="dottedline"/><?php endif; ?>
        <div class="commentList"  style="padding-left:<?php echo $vo['level']; ?>cm;text-align:left">
            <div>
                <span class="user">
                <?php if(($vo['pauthor'] == NULL)): ?><?php echo $vo['author']; else: ?> <?php echo $vo['author']; ?><span class="black" style="color: #000101">回复</span><?php echo $vo['pauthor']; endif; ?>
                </span>
