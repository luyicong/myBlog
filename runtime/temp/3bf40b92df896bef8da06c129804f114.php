<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\www\myBlog\public/../application/admin\view\webset\index.html";i:1501219342;s:56:"D:\www\myBlog\public/../application/admin\view\base.html";i:1500951663;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <?php if(($vo['webset_name']=='keywords') OR ($vo['webset_name'] == 'description') OR ($vo['webset_name'] == 'aboutblog')): ?>
                        <textarea class="form-control" rows="3" value="<?php echo $vo['webset_value']; ?>" onblur="edit(this,<?php echo $vo['webset_id']; ?>)"><?php echo $vo['webset_value']; ?></textarea>
                        <?php else: ?>
                        <input type="text" class="form-control" value="<?php echo $vo['webset_value']; ?>" onblur="edit(this,<?php echo $vo['webset_id']; ?>)">
                        <?php endif; ?>
                    </td>
                </tr>
...
//       alert($(obj).val());alert(webset_id);
        $.post("<?php echo url('edit'); ?>",{webset_id:webset_id,webset_value:$(obj).val()},function(res){
            if(res.code){
                //操作成功
