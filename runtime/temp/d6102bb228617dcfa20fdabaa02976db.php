<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\www\myBlog\public/../application/index\view\search\index.html";i:1515401518;s:56:"D:\www\myBlog\public/../application/index\view\base.html";i:1515465988;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
...
<div class="article_list" style="margin-top:10px;">
    <div class="list_title"><span>“”搜索结果</span></div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('#search_btn').on('click',function(){
            alert('....')
            window.location.href = "<?php echo url('index/search/index'); ?>?kw="+$("kw").val()
        })
    })
</script>
</html>
